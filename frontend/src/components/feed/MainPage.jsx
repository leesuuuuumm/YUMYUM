  ...
  return (
    <section className="login">
      <div className="userContainer">
        ...
        { loggedUser.email === profileUser.email && <Link to="/user/resetpassword" className="userLink">비밀번호 바꾸기</Link> }
        <Link to="/feed/createarticle" className="userLink"> 게시글 작성</Link>
